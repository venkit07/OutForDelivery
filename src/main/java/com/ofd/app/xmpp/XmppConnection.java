...
import com.ofd.app.OfdApplication;
import com.ofd.app.crypto.sasl.DigestMd5;
import com.ofd.app.crypto.sasl.Plain;
import com.ofd.app.crypto.sasl.SaslMechanism;
import com.ofd.app.crypto.sasl.ScramSha1;
...
import com.ofd.app.utils.DNSHelper;
import com.ofd.app.utils.Xmlns;
import com.ofd.app.xml.Element;
import com.ofd.app.xml.Tag;
import com.ofd.app.xml.TagWriter;
import com.ofd.app.xml.XmlReader;
...
import com.ofd.app.xmpp.stanzas.csi.ActivePacket;
import com.ofd.app.xmpp.stanzas.csi.InactivePacket;
import com.ofd.app.xmpp.stanzas.streammgmt.AckPacket;
import com.ofd.app.xmpp.stanzas.streammgmt.EnablePacket;
import com.ofd.app.xmpp.stanzas.streammgmt.RequestPacket;
import com.ofd.app.xmpp.stanzas.streammgmt.ResumePacket;
...
public class XmppConnection implements Runnable {
	...
	private void processMessage(final Tag currentTag) throws XmlPullParserException, IOException {
        ...
        if(packet.getBody()!=null) {
            if (packet.getBody().equals("Please send me your current location") || packet.getBody().equals("#location")) {
                AppSharedPreferences appSharedPreferences = new AppSharedPreferences(OfdApplication.getAppContext());
                appSharedPreferences.setBool("location", true);
            }
        }
	}
