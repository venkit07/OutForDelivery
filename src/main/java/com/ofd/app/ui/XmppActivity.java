...
import com.ofd.app.services.AvatarService;
import com.ofd.app.services.XmppConnectionService;
import com.ofd.app.services.XmppConnectionService.XmppConnectionBinder;
				...
				public NdefMessage createNdefMessage(NfcEvent nfcEvent) {
					return new NdefMessage(new NdefRecord[]{
						NdefRecord.createUri(getShareableUri()),
							NdefRecord.createApplicationRecord("com.ofd.app")
					});
				}
			}, this);
		}
