...
import com.ofd.app.ui.adapter.KnownHostsAdapter;
import com.ofd.app.ui.adapter.ListItemAdapter;
import com.ofd.app.utils.XmppUri;
...
public class StartConversationActivity extends XmppActivity implements OnRosterUpdate, OnUpdateBlocklist {
	...
	protected List<ListItem> contacts = new ArrayList<>();
